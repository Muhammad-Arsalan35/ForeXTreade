-- Create task_completions table (simplified version)
...
-- Create a unique index for daily task completion (this is the proper way)
CREATE UNIQUE INDEX IF NOT EXISTS idx_task_completions_daily_unique 
ON task_completions(user_id, task_id, (completed_at::date));
