...
// Import middleware
import { authenticateToken, verifyAdmin, verifyVipLevel, verifyRole } from './middleware/auth.js';
...
app.use('/api/deposits', authenticateToken, verifyVipLevel(1), depositRoutes);
app.use('/api/withdrawals', authenticateToken, verifyVipLevel(1), withdrawRoutes);
