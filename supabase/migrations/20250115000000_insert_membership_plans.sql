...
-- Create video earning rates table if not exists
CREATE TABLE IF NOT EXISTS video_earning_rates (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    vip_level VARCHAR(10) NOT NULL UNIQUE,
...
('VIP9', 260),
('VIP10', 440)
ON CONFLICT (vip_level) DO UPDATE SET rate_per_video = EXCLUDED.rate_per_video;